...
object ErrorHandle:
  ...
  private def logAndFail(errorMsg: String, exception: Throwable): ZIO[Any, Throwable, Unit] =
    ZIO.logError(
  ...
  def catchException(service: String, exception: Throwable): ZIO[Any, Throwable, Unit] =
    exception match
